        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-sm">Empowering developers with daily DSA practice and AI-powered guidance.</p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#howItWorks" className="hover:text-indigo-500">How it Works</a></li>
          ...
          <div className="mt-12 pt-8 border-t border-neutral-800">
            <p className="text-center text-sm">© 2024 AlgoDaily. All rights reserved.</p>
          </div>
        </div>
      </footer>
    );
